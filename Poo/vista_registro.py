...
class VentanaRegistro(ctk.CTkToplevel): # 💡 Cambiado a CTkToplevel para que sea una ventana emergente/hija
    def __init__(self, servicio_autenticacion):
        ...
        self.title("Admin - Registrar Nuevo Usuario")
        ...
        self.lbl_titulo = ctk.CTkLabel(self.frame, text="Registrar Usuario", font=("Arial", 22, "bold"))
        ...
        self.btn_registrar = ctk.CTkButton(self.frame, text="Guardar en Sistema", command=self.ejecutar_registro, width=280, height=40, font=("Arial", 14, "bold"), fg_color="#2ecc71", hover_color="#27ae60")
    ...
    def ejecutar_registro(self):
        ...
        # 🚀 AHORA PASAMOS LA CÉDULA A LOS CONSTRUCTORES
        if rol == "Docente":
        ...
        if exito:
            self.lbl_mensaje.configure(text_color="green", text="¡Usuario registrado correctamente!")
            self.update()
